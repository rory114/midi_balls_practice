...
let ctrls = {
    ...
    seafloor:"https://images.theconversation.com/files/239870/original/file-20181009-72106-6bsj7z.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=1200&h=1200.0&fit=crop",
    clr1: {r:25, g:85, b:122}, //color 1
    clr2:{ r:200, g:50, b:80}, //color 2
    d_range: {min: 1, max:3}, //range of sphere diameters
    explode_factor: 0.05, //explode distance
    light_intensity: 2
